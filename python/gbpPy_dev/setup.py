...
def package_files(directory='gbpPy_dev/data'):
    """
...
setup(
    ...
    package_data={
        'gbpPy_dev': package_files()},
    entry_points={
        'console_scripts': [
            'update_gbpPy_docs=%s.scripts.update_gbpPy_docs:update_gbpPy_docs' %
            (package_name)]},

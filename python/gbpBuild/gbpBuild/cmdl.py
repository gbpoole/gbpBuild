...
class parser:
    ...
    def __init__(self,argv,positional_arguments=None,optional_arguments=None,n_positional_arguments=None):
        ...
        if (len(args)<n_required_positional_arguments):
            ...
            if(n_args>1):
                plural_string2='were'
            parser.error('program expects at least %d command-line argument%s.  '
                         '%d %s given instead: "%s".' % (n_required_positional_arguments,plural_string1,len(args),plural_string2,args,))
            ...
            if(n_args>1):
                plural_string2='were'
            parser.error('program expects no more than %d command-line argument%s.  '
                         '%d %s given instead: "%s".' % (n_required_positional_arguments,plural_string1,len(args),plural_string2,args,))
